...
import static com.javacup.tactics.masia13.model.PlayerSpecifications.ACELERATION_RATE;
import static com.javacup.tactics.masia13.model.PlayerSpecifications.CONTROL_DISTANCE;
import static com.javacup.tactics.masia13.model.PlayerSpecifications.ENERGY_RATE;
import static com.javacup.tactics.masia13.model.PlayerSpecifications.GOALKEEPER_CONTROL_DISTANCE_INSIDE_AREA;
import static com.javacup.tactics.masia13.model.PlayerSpecifications.GOALKEEPER_HEIGHT_INSIDE_AREA;
import static com.javacup.tactics.masia13.model.PlayerSpecifications.PLAYER_HEIGHT;

import java.util.Iterator;

import com.javacup.model.PlayerDetail;
import com.javacup.model.util.Constants;
import com.javacup.tactics.masia13.util.Aceleration;
...
public abstract class Player extends Position{
	...
	public Player(int index, PlayerDetail playerDetail){
		...
		this.speed = Constants.getSpeed(speedFactor);
		this.power = playerDetail.getPower();
		this.maxSpeedShoot = Constants.getKickVelocity(power);
	...
	public void update(double x, double y, double energy, double aceleration ) {
		...
		this.energy = energy;
		this.speedShoot = maxSpeedShoot*Math.min(energy*Constants.ENERGY_SHOT_FACTOR, 1);
	...
	public double getErrorAnglePercent(){
		return Constants.getAngularError(precision);
	}
